...
begin
	...
	insert into t_mpay (com_id,br_id,mpay_id,mpay_taxid,mpay_dat,mpay_autoadj,mpay_cktax,mpay_amt,mpay_whtax,mpay_gstwhtamt,mpay_namt,mpay_epl,mpay_cb,mpay_chq,mpay_chqdat,mpay_rat,mpay_rmk,sup_bill,sup_id,cur_id,m_yr_id,acc_id,mpay_can,mpay_ck,mpay_auth,acC_no,log_act,log_dat,usr_id,log_ip)
	values(@com_id,@br_id,@mpay_id,@mpay_taxid,@mpay_dat,@mpay_autoadj,@mpay_cktax,@mpay_amt,@mpay_whtax,@mpay_gstwhtamt,@mpay_namt,@mpay_epl,@mpay_cb,@mpay_chq,@mpay_chqdat,@mpay_rat,@mpay_rmk,@sup_bill,@sup_id,@cur_id,@m_yr_id,@acc_id,@mpay_can,@mpay_auth,@mpay_auth,@acc_no,@log_act,@log_dat,@usr_id,@log_ip)			
