...
--GL Voucher
			...
			set @mpay_auth=(select mpay_auth from t_mpay where mpay_id=@mpay_id)
		...
		if (@mvch_no is null)
			begin
				--Master Voucher
				exec ins_t_mvch @com_id,@br_id,@m_yr_id,@mpay_chqdat ,@mpay_dat ,@sup_nam,'01',@mvch_typ,@mvch_app,@mpay_cb ,@mpay_rmk,'S',@mpay_chq,@mpay_chqdat,0,0,@cur_id,@mpay_rat,@mpay_can,0,'','','','','','',@mvch_no_out=@mvch_no output
			...
			begin
				exec upd_t_mvch @com_id ,@br_id ,@m_yr_id ,@mvch_no ,@mpay_chqdat ,@mvch_typ,@mvch_app,@sup_nam,'01',@mpay_cb,@mpay_rmk,@mpay_chq,@mpay_chqdat,0,0,@cur_id,@mpay_rat,'S',@mpay_can,0,'','','',''
		...
		exec ins_t_dvch @com_id,@br_id,@mvch_no,@row_id,@sup_acc,@mvch_nar,@mpay_namt,0
		...
		set @row_id=@row_id+1
		exec ins_t_dvch @com_id,@br_id,@mvch_no,@row_id,@acc_id,@mvch_nar,0,@mpay_amt
		...
		if (@mpay_epl!=0) 
			begin
					...
					if (@mvch_no_epl is null)
						begin
							--Master Voucher
							exec ins_t_mvch @com_id,@br_id,@m_yr_id,@mpay_chqdat ,@mpay_dat ,@sup_nam,'01',@mvch_typ,'Y','C' ,@mpay_rmk,'S',0,@mpay_chqdat,0,0,@cur_id,@mpay_rat,@mpay_can,@mpay_cktax,'','','','','','',@mvch_no_out=@mvch_no_epl output
						...
						begin
							exec upd_t_mvch @com_id ,@br_id ,@m_yr_id ,@mvch_no_epl ,@mpay_chqdat ,@mvch_typ,@mvch_app,@sup_nam,'01','C',@mpay_rmk,@mpay_chq,@mpay_chqdat,0,0,@cur_id,@mpay_rat,'S',@mpay_can,@mpay_cktax,'','','',''
...
--Taxable 
	if (@mpay_cktax =1)
		begin
			...
			set @mvch_nar='Payment ID # ' +rtrim(@mpay_id)+' Supplier '+rtrim(@sup_nam) + ' ' +@sup_bill+ ' ' + @mpay_rmk
			set @row_id=@row_id+1
			exec ins_t_dvch @com_id,@br_id,@mvch_taxno,@row_id,@acc_id,@mvch_nar,0,@mpay_amt
