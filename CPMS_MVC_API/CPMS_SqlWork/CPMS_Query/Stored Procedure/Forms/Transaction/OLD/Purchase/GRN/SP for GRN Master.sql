...
begin
	...
	insert into t_mgrn(com_id,br_id,mgrn_id,mgrn_dat,mgrn_typ,mpo_id,m_yr_id,sup_dc,sup_dcdat,mgrn_kepz,mgrn_rmk,mgrn_rat,mgrn_amt,cur_id,mgrn_act,mgrn_nw,sca_id,wh_id,mgrn_auth,mgrn_idold,lot_id,log_act,log_dat,usr_id,log_ip)
			values(@com_id,@br_id,@mgrn_id,@mgrn_dat,@mgrn_typ,@mpo_id,@m_yr_id,@sup_dc,@sup_dcdat,@mgrn_kepz,@mgrn_rmk,@mgrn_rat,@mgrn_amt,@cur_id,@mgrn_act,@mgrn_nw,@sca_id,@wh_id,@mgrn_auth,@mgrn_idold,@lot_id,@log_act,@log_dat,@usr_id,@log_ip)
...
begin
	...
	update t_mgrn set mgrn_dat=@mgrn_dat,sup_dc=@sup_dc,sup_dcdat=@sup_dcdat,mgrn_kepz=@mgrn_kepz,mgrn_rmk=@mgrn_rmk,mgrn_rat=@mgrn_rat,mgrn_amt=@mgrn_amt,cur_id=@cur_id,mgrn_act=@mgrn_act,wh_id=@wh_id,mgrn_nw=@mgrn_nw,mgrn_auth=@mgrn_auth,sca_id=@sca_id,log_act=@log_act,log_dat=@log_dat,usr_id=@usr_id,log_ip=@log_ip where mgrn_id=@mgrn_id
  --Audit
  exec sp_ins_log @log_frmnam,@log_act,@usr_id,@log_ip,@log_oldval,@log_newval,@log_dat
