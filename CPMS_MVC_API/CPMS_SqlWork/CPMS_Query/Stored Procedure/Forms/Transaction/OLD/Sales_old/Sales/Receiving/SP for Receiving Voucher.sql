			...
			if (@mrec_epl!=0) 
				begin
						...
						if (@mvch_taxno_epl is null)
							begin
								--Master Voucher
								exec ins_t_mvch @com_id,@br_id,@m_yr_id,@mrec_chqdat ,@mrec_dat ,@cus_nam,'01',@mvch_typ,'Y','C' ,@mrec_rmk,'S',0,@mrec_chqdat,0,0,@cur_id,@mrec_rat,@mrec_can,'','','','','','',@mvch_no_out=@mvch_taxno_epl output
								--Update the voucher number and type
							...
							begin
								exec upd_t_mvch @com_id ,@br_id ,@m_yr_id ,@mvch_taxno_epl ,@mrec_chqdat ,@mvch_typ,'Y',@cus_nam,'01','C',@mrec_rmk,@mrec_chq,@mrec_chqdat,0,0,@cur_id,@mrec_rat,'S',@mrec_can,'','','',''
