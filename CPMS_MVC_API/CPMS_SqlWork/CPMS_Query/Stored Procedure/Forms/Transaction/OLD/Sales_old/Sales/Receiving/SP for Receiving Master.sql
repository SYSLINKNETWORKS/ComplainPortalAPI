...
begin
	...
	insert into t_mrec (com_id,br_id,m_yr_id,mrec_id,mrec_no,mrec_taxid,mrec_gstwhtamt,mrec_dat,mrec_epl,mrec_cb,cusbk_id,mrec_chq,mrec_chqdat,mrec_autoadj,mrec_rat,mrec_rmk,mrec_cktax,mrec_amt,mrec_intax,mrec_namt,cus_id,cur_id,acc_no,mrec_can,mrec_idold,log_act,log_dat,usr_id,log_ip)
				values(@com_id,@br_id,@m_yr_id,@mrec_id,@mrec_no,@mrec_taxid,@mrec_gstwhtamt,@mrec_dat,@mrec_epl,@mrec_cb,@cusbk_id,@mrec_chq,@mrec_chqdat,@mrec_autoadj,@mrec_rat,@mrec_rmk,@mrec_cktax,@mrec_amt,@mrec_intax,@mrec_namt,@cus_id,@cur_id,@acc_no,@mrec_can,@mrec_idold,@log_act,@log_dat,@usr_id,@log_ip)			
...
begin
	...
	update t_mrec set log_act=@log_act where mrec_id=@mrec_id
