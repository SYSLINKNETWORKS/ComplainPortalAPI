...
--GL Voucher
		...
		if (@mvch_no is null)
			begin
				--Master Voucher
				exec ins_t_mvch @com_id,@br_id,@m_yr_id,@mpb_dat ,@mpb_dat ,'','01','05','Y','C' ,@mpb_rmk,'S','',@mpb_dat,0,0,@cur_id,@mpb_rat,@mpb_can,0,'','','','','','',@mvch_no_out=@mvch_no output
	...
	if (@mpb_cktax =1)
		begin
				...
				if (@mvch_taxno is null)
					begin
						--Master Voucher
						exec ins_t_mvch @com_id,@br_id,@m_yr_id,@mpb_dat ,@mpb_dat ,'','01','05','Y','C' ,@mpb_rmk,'S','',@mpb_dat,0,0,@cur_id,@mpb_rat,@mpb_can,@mpb_cktax,'','','','','','',@mvch_no_out=@mvch_taxno output
